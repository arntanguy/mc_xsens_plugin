...
struct XsensBodyMappings
{
  ...
  const auto & bodyConfigurations() const noexcept { return bodyConfigurations_; }
...
struct ConfigurationLoader<mc_xsens_plugin::XsensBodyMappings>
{
  ...
  static mc_rtc::Configuration save(const mc_xsens_plugin::XsensBodyMappings & object) { return object.save(); }
};
} // namespace mc_rtc
